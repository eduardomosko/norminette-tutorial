...
Colocar o cabeçalho pode ser feito com `f2` pelo vim e esqueci o atalho `CTRL+ALT+H` pelo editor normal. Uma coisa importante de saber é que se você não deixar uma linha em branco entre o cabeçalho e os includes, o editor vai deletar os conteúdos daquela linha sem te avisar.
